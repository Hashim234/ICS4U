...
/**ICS3U
 * TicTacToe Rules.java
 *  the rules for tictactoe 
 * Hashim Hashi
 *20/09/16
 */
public class TicTacToeRules {
	...
	public static void main(String[] args) {
		 ...
		 System.out.println( "4. Steps 2 and 3 are repeated until a tic tac Pattern is created: Patterns can be diagnol, horizontal, or verical.\n" );
		 
		 System.out.println( "5. Aw innig pattern is completed by drawing a line through the pattern.\n" );
	}
